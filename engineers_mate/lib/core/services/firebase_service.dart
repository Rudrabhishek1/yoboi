...
class FirebaseService {
  ...
  static Future<List<CustomFormulaData>> fetchRemoteFormulas() async {
    ...
    try {
      ...
      // 🛡️ Sentinel: Validate top-level structure and ensure elements are Map<String, dynamic>
      // Prevents runtime TypeError crashes (DoS) from malformed remote payloads.
      if (decoded is! List) return [];

      final jsonList = decoded.whereType<Map<String, dynamic>>().toList();
