...
class CustomFormulaData {
  ...
  factory CustomFormulaData.fromMap(Map<String, dynamic> map) {
    // 🛡️ Sentinel: Validate dynamic map fields to prevent crashes from malformed remote payloads
    final dynamic labels = map['inputLabels'];
    return CustomFormulaData(
      id: map['id']?.toString() ?? '',
      title: map['title']?.toString() ?? '',
      inputLabels: labels is List
